      ...
      <div className="p-4 mx-auto text-gray-900  bg-gray-50 shadow-lg rounded ">
        <div className="flex text-sm justify-between items-center border-b pb-4 m-4">
          <div className=" font-semibold">
            TOTAL ITEMS : {reservation.length}{" "}
          </div>
        </div>
              ...
              {reservation.map((item, index) => (
                ...
                >
                  ...
                  <td className="p-3 flex gap-2">
                    <button className="bg-emerald-500 hover:bg-emerald-700 p-1  rounded text-white">
                      <MdDone size={16} />
                    </button>
                    <button className="bg-red-500 hover:bg-red-700 p-1  rounded text-white">
                      <MdCancel size={16} />
                    </button>
                  </td>
                </tr>
